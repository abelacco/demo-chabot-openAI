...
const getCurrentCalendar = async (): Promise<string> => {
    const dataCalendarApi = await fetch('https://hook.us1.make.com/97vt4shacuojqr26xdck1wnjnto3sroa')
...
const appToCalendar = async (text: string) => {
    try {
        ...
        console.log(payload)
        const dataApi = await fetch('https://hook.us1.make.com/cen0qjkksvg9ko8hfnaswrfw4jfi4i18', {
            method: 'POST',
            headers: {
